...
four that live only under `docs/`; within each group, in the order their
...
| [Backlog](backlog/index.md)     | —            | `docs/backlog/<slug>.md`            | until done            | what one queued item is, in full                   |
