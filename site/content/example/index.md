...
`README.md`, `AGENTS.md`, and `CHANGELOG.md` never move. Backlog, Decisions,
Runbooks, and Incidents have only a graduated path and live under `docs/`
from their first entry, whether or not the rest of the repository has
graduated. Nothing exists at both the small-repo path and the graduated path
at once.
